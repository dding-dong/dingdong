...
public class OrderExceptionHandler {
	...
	public ResponseEntity<BaseResponseDto<Void>> handleOrderAlreadyCompletedException(
	...
	public ResponseEntity<BaseResponseDto<Void>> handleOrderPermissionDeniedException(
		OrderPermissionDeniedException ex) {
	...
	public ResponseEntity<BaseResponseDto<Void>> handleOrderDeliveryUnavailableException(
		OrderDeliveryUnavailableException ex) {
	...
	public ResponseEntity<BaseResponseDto<Void>> handleOrderCancelTimeExceededException(
		OrderCancelTimeExceededException ex) {
