...
public class StoreControllerV1 {
	...
	@PreAuthorize("true")
	public ResponseEntity<List<StoreDto.Response>> getActiveStoresByCategory(@PathVariable UUID storeCategoryId) {
	...
	public ResponseEntity<StoreDto.Response> create(
	...
	@PreAuthorize("hasRole('OWNER')")
	public ResponseEntity<StoreDto.Response> getMyStore(@PathVariable UUID storeId) {
	...
	@PreAuthorize("hasRole('OWNER')")
	public ResponseEntity<StoreDto.Response> update(
	...
	public ResponseEntity<List<StoreDto.Response>> getAll() {
	...
	@PreAuthorize("hasAnyRole('MANAGER','MASTER')")
	public ResponseEntity<List<StoreDto.Response>> getAllByCategory(@PathVariable UUID storeCategoryId) {
	...
	@PreAuthorize("hasAnyRole('MANAGER','MASTER')")
	public ResponseEntity<StoreDto.Response> getById(@PathVariable UUID storeId) {
	...
	@PreAuthorize("hasAnyRole('MANAGER','MASTER')")
	public ResponseEntity<StoreDto.Response> manageUpdate(
		@PathVariable UUID storeId,
		@Valid @RequestBody StoreDto.Request req) {
	...
	@PreAuthorize("hasAnyRole('MANAGER','MASTER')")
	public ResponseEntity<StoreDto.Response> forceUpdateStatus(
		@PathVariable UUID storeId,
		@RequestBody StoreDto.UpdateStatusRequest req) {
	...
	@PreAuthorize("hasAnyRole('MANAGER', 'MASTER')")
	public ResponseEntity<StoreDto.Response> restore(
		@Parameter(description = "가게 UUID") @PathVariable UUID storeId) {
		StoreDto.Response restored = storeService.restore(storeId);
