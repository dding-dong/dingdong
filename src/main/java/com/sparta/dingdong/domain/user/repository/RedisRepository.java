...
public class RedisRepository {
	...
	private static final String TOKEN_VERSION_PREFIX = "auth:version:";
	...
	public void incrementTokenVersion(Long userId, long ttlMillis) {
		Long currentVersion = getTokenVersion(userId);
		long newVersion = (currentVersion != null ? currentVersion + 1 : 1L);
		saveTokenVersion(userId, newVersion, ttlMillis);
	}
}
